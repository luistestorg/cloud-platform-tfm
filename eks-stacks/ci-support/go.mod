module cloud-platform-tfm/eks-stacks/ci-support
...
require (
	...
	github.com/pulumi/pulumi-aws-iam/sdk v0.2.0 // indirect
	...
	github.com/pulumi/pulumi-gcp/sdk/v8 v8.29.0 // indirect
	...
	unir-tfm.com/resources v0.0.0 // indirect
)
